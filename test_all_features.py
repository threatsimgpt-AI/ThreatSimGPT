...
Usage:
    KMP_DUPLICATE_LIB_OK=TRUE python test_all_features.py [--verbose] [--dry-run] [--skip-api-tests]
...
# Set environment variable at the very beginning to avoid OpenMP conflicts
